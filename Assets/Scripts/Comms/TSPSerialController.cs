 ...
 * data.
 */
public class TSPSerialController : MonoBehaviour
{
    ...
    public int reconnectionDelay = 5000;

    [Tooltip("Maximum number of unread data messages in the queue. " +
             "New messages will be discarded.")]
    public int maxUnreadMessages = 1;

    [Tooltip("The character seperating messages.")]
    public byte delimeter = 0xff;
    ...
    protected TSPSerialThread serialThread;
    ...
    void OnEnable()
    {
        serialThread = new TSPSerialThread(portName, 
                                             baudRate, 
                                             reconnectionDelay,
                                             maxUnreadMessages);
